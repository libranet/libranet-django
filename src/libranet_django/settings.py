...
ROOT_URLCONF = "libranet_django.urls"
...
WSGI_APPLICATION = "libranet_django.utils.wsgi.application"
ASGI_APPLICATION = "libranet_django.utils.asgi.application"
...
MEDIA_ROOT = os.getenv("MEDIA_DIR")  # cfg.media_dir
MEDIA_URL = "/media/"
